...
We encourage users and researchers to use PGP-encrypted emails to
transmit confidential details regarding possible vulnerabilities in
this package.

Details should be sent to: j [at] pureftpd [dot] org using the PGP key below:
